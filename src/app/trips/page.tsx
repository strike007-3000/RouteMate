...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen bg-background pb-20 max-w-md mx-auto border-x border-border/50 shadow-2xl shadow-black/50 overflow-x-hidden">
      {/* Premium Header */}
      <header className="p-8 pb-12 pt-16 relative">
        ...
        >
          <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em] mb-4 block">Pocket Intelligence</span>
          <h1 className="text-4xl font-black text-white tracking-tighter leading-none mb-2">My Trips</h1>
          <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest">Plan smarter, travel cheap.</p>
        </motion.div>

        <button 
          onClick={handleCreateNew}
          className="mt-8 group relative w-full h-14 bg-primary rounded-2xl flex items-center justify-center gap-3 overflow-hidden active:scale-95 transition-transform"
        >
      ...
      <section className="px-6 space-y-12">
        ...
        {upcomingTrips.length > 0 && (
          <div>
            <div className="flex items-center gap-3 mb-6 px-2">
              ...
              <h2 className="text-[10px] font-black text-white uppercase tracking-[0.4em]">Upcoming Adventures</h2>
            </div>
        ...
        {trips.length === 0 && (
          ...
          >
            ...
            <h3 className="text-lg font-black text-white mb-2">No trips planned yet</h3>
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto glass h-20 px-10 flex items-center justify-around z-50">
        <button className="flex flex-col items-center gap-1 opacity-100">
           <Globe className="w-5 h-5 text-primary" />
           <span className="text-[8px] font-black text-primary uppercase tracking-widest">Trips</span>
        </button>
